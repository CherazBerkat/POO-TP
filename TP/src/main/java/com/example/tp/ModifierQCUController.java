...
public class ModifierQCUController {
    @FXML
    ...
    public void initialize() {
        ...
        saveButton.setOnAction(event -> {
            qcu.setText(text.getText().toString());
        });
        ...
        listC.setItems(FXCollections.observableArrayList(qcu.getPropos().entrySet()));
                ...
                return new ListCell<>() {
...

                    {
                        ...
                        saveButton.setOnAction(event -> {
                            ...
                            if (item != null) {
                                qcu.getPropos().put(textField.getText(), item.getValue());
                        ...
                        deleteButton.setOnAction(event -> {
                            Map.Entry<String, Integer> item = getItem();
                            if (item != null) {
                                qcu.getPropos().remove(item.getKey());
                        ...
                        toggleCorrectButton.setOnAction(event -> {
                            ...
                            if (item != null) {
                                ...
                                if (newValue == 1) {
                                    // If the new value is 1, update all elements' values to 0
                                    for (Map.Entry<String, Integer> entry : listC.getItems()) {
                                        if (entry != item) {
                                            entry.setValue(0);
                                        }
                                    }
